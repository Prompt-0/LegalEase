document.addEventListener('DOMContentLoaded', () => {
  ...
  return "To file an FIR (First Information Report):\n\n1. Visit the nearest police station (or file online if available in your state).\n2. Clearly state the details of the incident to the officer.\n3. The officer will record the information and provide you with a copy of the FIR for free."
